...
//        }
//
//        Particle point_mass = Particle(pos, pos);
...
//    } else {
//      vector<Particle *> *new_vector = new vector<Particle *>();
...
//  float hash_pos = hash_position(pm.position);
//  vector<Particle *> *hash_pms = map[hash_pos];
//
//  int count = 0;
//  Vector3D correction_sum = Vector3D(0.0, 0.0, 0.0);
//  for (Particle* candidate_pm: *hash_pms) {
//    if (candidate_pm == &pm){
//      continue;
//    }
...
//      Particle *pm = &point_masses[y * num_width_points + x];
...
//      Particle *pm_A = pm                       ;
//      Particle *pm_B = pm                    + 1;
//      Particle *pm_C = pm + num_width_points    ;
//      Particle *pm_D = pm + num_width_points + 1;
//
